    ...
    public String getUuid_Name(){
      ...
      switch (uuid){
          ...
          case "00000015-0000-0010-1005-000000101005":
              return "服務台(A5)";
          case "00000015-0000-0010-1006-000000101006":
              return "前門出口(A6)";
          case "00000015-0000-0010-1007-000000101007":
              return "前門出口(A7)";
          case "00000015-0000-0010-1011-000000101011":
              return "批價櫃檯(A11)";
          case "00000015-0000-0010-1009-000000101009":
              return "前門出口(A9)";
          ...
          case "00000015-0000-0010-1017-000000101017":
              return "健康教育中心(A17)";
          case "00000015-0000-0010-1018-000000101018":
              return "新大樓一樓樓梯(A18)";
          ...
          case "00000015-0000-0000-0101-000000000101":
              return "新舊大樓連接走廊(C1)";
          case "00000015-0000-0000-0202-000000000202":
          ...
          case "00000015-0000-0000-0505-000000000505":
              return "抽血(C5)";
          case "00000016-0000-0001-9500-000000014500":
              return "大廳(病歷室前)(C8)";
          case "00000015-0000-0000-0909-000000000909":
              return "大廳(電腦斷層室前)(C11)";
          case "00000015-0000-0000-0707-000000000707":
              return "後門出口(後)(C10)";
          case "00000016-0000-0002-4000-000000026000":
          ...
          case "00000016-0000-0002-8500-000000017000":
              return "心臟血管功能檢查室(D5)";
          case "00000016-0000-0002-8500-000000014500":
              return "迴轉樓梯(心臟血管功能檢查室)(D6)";
          case "00000014-0000-0010-1101-000000101101":
              return "樓梯(新大樓B1)(B1)";
